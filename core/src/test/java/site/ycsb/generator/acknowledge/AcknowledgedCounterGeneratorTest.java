...
public class AcknowledgedCounterGeneratorTest {
  ...
  public void testIncrementPastIntegerMaxValue() {
    final long toTry = DefaultAcknowledgedCounterGenerator.DEFAUL_WINDOW_SIZE * 3;

    DefaultAcknowledgedCounterGenerator generator =
        new DefaultAcknowledgedCounterGenerator(Integer.MAX_VALUE - 1000);
